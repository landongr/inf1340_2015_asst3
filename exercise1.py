...
def selection(t, f):
    ...
    :param f: A function to be performed on that table
    :return: The new table generated by performing the function on table t
    Example:
    > R = [["A", "B", "C"], [1, 2, 3], [4, 5, 6]]
...
def projection(t, r):
    ...
    :param t: A table (a list of lists)
    :param r: A list of attributes to filter the columns of table t
    :return: The new table generated by filtering the columns for attributes r
    :raises: UnknownAttributeException:
        if an attribute is in attributes list r but not in table t
    Example:
    > R = [["A", "B", "C"], [1, 2, 3], [4, 5, 6]]
    > projection(R, ["A", "C"])
    [["A", "C"], [1, 3], [4, 6]]
...
def cross_product(t1, t2):
    ...
    :param t1: A table
    :param t2: A table
    :return: The new table generated by matching each row from t1 with every row in t2
    Example:
    > R1 = [["A", "B"], [1,2], [3,4]]
    > R2 = [["C", "D"], [5,6]]
    ...
    new_table = t1[0] + t2[0]
    new2_table = []
    # Removes the Schema headings from the 2 tables THIS IS ACTUALLY DELETING THESE FROM THE ORIGINAL TABLES!
    del t1[0]
    del t2[0]
...
#print cross_product(CATS, DOGS)
#print " "
#print cross_product(DOGS, CATS)
#SOMETHING IS CAUSING THE SECOND ONE TO BE REALLY WEIRD... I THINK WE HAVE AN ISSUE WITH OUR FUNCTION
#THINK IT'S ACTUALLY DELETING THE COLUMN HEADINGS
